...
"selection-background-color: rgb(255, 0, 127);")
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(70, 780, 161, 51))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(480, 780, 161, 51))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_3.setText(_translate("MainWindow", "Delete Task"))
    ...
    def delete(self):
            ...
            id = indexes[0]
            db = DBHandler()
            db.deleteTask(id.data())
            self.showListTaskFrame()
            self.todaysTaskDesc.clear()
            self.todaysTaskTitle.clear()
            self.todaysTaskDateTime.clear()
            # db.update_task_numbers()
